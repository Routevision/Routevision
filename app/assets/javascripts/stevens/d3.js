(function() {
  ...
  d3.geo.mercator = function() {
    function mercator(coordinates) {
      ...
      // console.log(Math.PI / 4 + coordinates[1] * d3_geo_radians / 2);
      // console.log(Math.tan(Math.PI / 4 + coordinates[1] * d3_geo_radians / 2));
      attempt = Math.log(Math.tan(Math.PI / 4 + coordinates[1] * d3_geo_radians / 2));
      if(isNaN(attempt)) {
        console.log(coordinates[1]);
        console.log(Math.tan(Math.PI / 4 + coordinates[1] * d3_geo_radians / 2));
        console.log(Math.log(Math.tan(Math.PI / 4 + coordinates[1] * d3_geo_radians / 2)));
      }
